package machine.microspin.com.drawframe_console;
...
import machine.microspin.com.drawframe_console.fragment.DiagnosticsFragment;
import machine.microspin.com.drawframe_console.fragment.RunModeFragment;
import machine.microspin.com.drawframe_console.fragment.SettingsFragment;
import machine.microspin.com.drawframe_console.fragment.UtilitiesFragment;
        ...
        if (runFragment instanceof RunModeFragment) {
            try {
                ...
                if (!payload.isEmpty()) {
                    ...
                    switch (payload) {
                        case "XXNORMAL":
                            packetPayload = "7E011501020102010305044118000006043F99999A000200007E"; //DrawFrame
                            break;
                        case "XXPAUSE1"://USER PRESS
                            packetPayload = "7E01130102010311030102000800020000000200007E"; //DrawFrame - Pause
                            break;
                        case "XXPAUSE2":// sliver cut - needs to be updated in embedded code
                            packetPayload = "7E01130102010311030102000900020000000200007E";
                            break;
                        case "XXHALT": // RPM ERROR TO CHECK
                            packetPayload = "7E01150102010312030102001E020200020304000000007E"; //DrawFrame - Halt
                            break;
                        case "XXLIMIT": // Limit reached TO CHECK
                            packetPayload = "7E01150102010312030102000C00020000000200007E"; //DrawFrame -
                            break;
                        case "XXLAPPING": // Lapping
                            packetPayload = "7E01150102010312030102000E00020000000200007E"; //DrawFrame -
                            break;
                        case "XXIDLE":
                            packetPayload = "7E01000101010100007E";
                            break;
                        case "XXSETTING":
                            packetPayload = "7E0113010202040001402442d266664020000000C87E"; //DrawFrame - Settings
                            break;
                        case "XXACK":
                        ...
                        case "XXSAVED":
                            ...
                            break;
                        case "XXPIDSETTING":
                            packetPayload = "7E0110010202060001AA16032000F5001400FA7E";
                            break;
